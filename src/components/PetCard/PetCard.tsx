      ...
      <div className="relative aspect-square w-full overflow-hidden bg-gray-50">
        <div className="absolute right-2 top-2 z-10 flex flex-col gap-2">
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-white/70 backdrop-blur text-slate-700 ring-1 ring-blue-100 shadow-sm transition hover:scale-105 hover:bg-white"
            title="Add to cart"
          >
